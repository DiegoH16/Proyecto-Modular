/*
 * DISPOSITIVO BÍCEPS: MAX30105 (V3.3 OFFLINE CLIENT)
 * Corrección: Capping de saturación para mantener linealidad de Fs.
 */
#include <Wire.h>
#include "MAX30105.h"
#include <WiFi.h>
...
void loop() {
  ...
  while (particleSensor.available()) {
    ...
    // ✅ MITIGACIÓN CRÍTICA: Saturación en lugar de descarte
